...
const Employee = ({ item }) => (
  <View className="flex-row justify-between items-center gap-3 py-3 px-6 border-b border-gray-200">
    ...
    <View className="flex-1 justify-center">
      <Text className="text-base font-semibold">{item.address}</Text>
  ...
  return (
    <View className="flex-1">
      ...
      <SafeAreaView className="flex-1">
        <Header navigation={navigation} text="Quản lý chi nhánh" />
        ...
        <View className="px-6 py-6 bg-gray-100">
          <TouchableOpacity className="bg-primary py-4 block w-full rounded-lg items-center">
            <Text className="text-white font-medium">Thêm chi nhánh</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </View>
